...
Website: **Schedule** + **Playoffs** (tournament graph) + **Predictions**. Group-stage picks (10 pts) lock Saturday **10:00 PM PKT**. **The International** tab (upper / lower / Grand Final 50 pts) stays locked until every group match is done. One combined points board. After groups: 4th out, A3 vs B3 Advancement Bo1, then double-elim. Grand Final **Bo3**.
